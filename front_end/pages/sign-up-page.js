export default function drawSignUpPage() {
    ...
    // 로그인 버튼 클릭 이벤트 구현 예정!!
    $loginSignUpBox.innerHTML += `<input id="write-id" type="text" placeholder="id를 입력하시오" style="height:40px"><input class="blue-button" type="button" value="나가기" data-link="login" /><input class="blue-button" type="button" value="로그인" data-link="구현 필요!!" />`;
}